...
var PageName = 'Управление файлами';
var PageId = '40f8ce6311c9474e91752d987224d7f9'
var PageUrl = 'Управление_файлами.html'
document.title = 'Управление файлами';
var PageNotes = 
{
"pageName":"Управление файлами",
...
if (true) {
	...
	NewWindow("resources/Other.html#other=" + encodeURI("Вы точно хотите удалить этот файл? Восстановить его будет уже невозможно..."), "", "directories=0, height=300, location=0, menubar=0, resizable=1, scrollbars=1, status=0, toolbar=0, width=300", true, 300, 300);
